...
//JCP>         } else if (columnType == Types.REF_CURSOR && functionReturnType[j] == Types.OTHER) {
//JCP>           // For backwards compatibility reasons we support that ref cursors can be
//JCP>           // registered with both Types.OTHER and Types.REF_CURSOR so we allow
//JCP>           // this specific mismatch
          //JCP! endif
        } else {
  ...
  //JCP! if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.2"
//JCP>   public void setObject(String parameterName, Object x, java.sql.SQLType targetSqlType,
...
//JCP>   }
//JCP> 
//JCP>   public void registerOutParameter(int parameterIndex, java.sql.SQLType sqlType)
//JCP>       throws SQLException {
//JCP>     throw Driver.notImplemented(this.getClass(), "registerOutParameter");
//JCP>   }
//JCP> 
//JCP>   public void registerOutParameter(int parameterIndex, java.sql.SQLType sqlType, int scale)
//JCP>       throws SQLException {
//JCP>     throw Driver.notImplemented(this.getClass(), "registerOutParameter");
//JCP>   }
//JCP> 
//JCP>   public void registerOutParameter(int parameterIndex, java.sql.SQLType sqlType, String typeName)
//JCP>       throws SQLException {
//JCP>     throw Driver.notImplemented(this.getClass(), "registerOutParameter");
//JCP>   }
//JCP> 
//JCP>   public void registerOutParameter(String parameterName, java.sql.SQLType sqlType)
//JCP>       throws SQLException {
//JCP>     throw Driver.notImplemented(this.getClass(), "registerOutParameter");
//JCP>   }
//JCP> 
//JCP>   public void registerOutParameter(String parameterName, java.sql.SQLType sqlType, int scale)
//JCP>       throws SQLException {
//JCP>     throw Driver.notImplemented(this.getClass(), "registerOutParameter");
//JCP>   }
//JCP> 
//JCP>   public void registerOutParameter(String parameterName, java.sql.SQLType sqlType, String typeName)
//JCP>       throws SQLException {
//JCP>     throw Driver.notImplemented(this.getClass(), "registerOutParameter");
//JCP>   }
  //JCP! endif
