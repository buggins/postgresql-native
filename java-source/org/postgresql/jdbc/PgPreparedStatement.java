...
class PgPreparedStatement extends PgStatement implements PreparedStatement {
  ...
  public void setNull(int parameterIndex, int sqlType) throws SQLException {
    ...
    switch (sqlType) {
      ...
      case Types.TIME:
      //JCP! if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.2"
//JCP>       case Types.TIME_WITH_TIMEZONE:
//JCP>       case Types.TIMESTAMP_WITH_TIMEZONE:
      //JCP! endif
      ...
      case Types.DATE:
        if (in instanceof java.sql.Date) {
          ...
          if (in instanceof java.util.Date) {
            ...
            //JCP! if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.2"
//JCP>           } else if (in instanceof LocalDate) {
//JCP>             setDate(parameterIndex, (LocalDate) in);
//JCP>             break;
            //JCP! endif
          } else {
      ...
      case Types.TIME:
        if (in instanceof java.sql.Time) {
          ...
          if (in instanceof java.util.Date) {
            ...
            //JCP! if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.2"
//JCP>           } else if (in instanceof LocalTime) {
//JCP>             setTime(parameterIndex, (LocalTime) in);
//JCP>             break;
            //JCP! endif
          } else {
      ...
      case Types.TIMESTAMP:
        if (in instanceof PGTimestamp) {
          ...
          if (in instanceof java.util.Date) {
            ...
            //JCP! if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.2"
//JCP>           } else if (in instanceof LocalDateTime) {
//JCP>             setTimestamp(parameterIndex, (LocalDateTime) in);
//JCP>             break;
            //JCP! endif
          } else {
      ...
      //JCP! if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.2"
//JCP>       case Types.TIMESTAMP_WITH_TIMEZONE:
//JCP>         if (in instanceof OffsetDateTime) {
//JCP>           setTimestamp(parameterIndex, (OffsetDateTime) in);
//JCP>         } else if (in instanceof PGTimestamp) {
//JCP>           setObject(parameterIndex, in);
//JCP>         } else {
//JCP>           throw new PSQLException(
//JCP>               GT.tr("Cannot cast an instance of {0} to type {1}",
//JCP>                   in.getClass().getName(), "Types.TIMESTAMP_WITH_TIMEZONE"),
//JCP>               PSQLState.INVALID_PARAMETER_TYPE);
//JCP>         }
//JCP>         break;
      //JCP! endif
      case Types.BIT:
  ...
  public void setObject(int parameterIndex, Object x) throws SQLException {
    ...
    if (x == null) {
      ...
      //JCP! if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.2"
//JCP>     } else if (x instanceof LocalDate) {
//JCP>       setDate(parameterIndex, (LocalDate) x);
//JCP>     } else if (x instanceof LocalTime) {
//JCP>       setTime(parameterIndex, (LocalTime) x);
//JCP>     } else if (x instanceof LocalDateTime) {
//JCP>       setTimestamp(parameterIndex, (LocalDateTime) x);
//JCP>     } else if (x instanceof OffsetDateTime) {
//JCP>       setTimestamp(parameterIndex, (OffsetDateTime) x);
      //JCP! endif
  ...
  //JCP! if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.2"
//JCP>   private void setDate(int i, LocalDate localDate) throws SQLException {
//JCP>     int oid = Oid.DATE;
//JCP>     bindString(i, connection.getTimestampUtils().toString(localDate), oid);
//JCP>   }
//JCP> 
//JCP>   private void setTime(int i, LocalTime localTime) throws SQLException {
//JCP>     int oid = Oid.TIME;
//JCP>     bindString(i, connection.getTimestampUtils().toString(localTime), oid);
//JCP>   }
//JCP> 
//JCP>   private void setTimestamp(int i, LocalDateTime localDateTime) throws SQLException {
//JCP>     int oid = Oid.TIMESTAMP;
//JCP>     bindString(i, connection.getTimestampUtils().toString(localDateTime), oid);
//JCP>   }
//JCP> 
//JCP>   private void setTimestamp(int i, OffsetDateTime offsetDateTime) throws SQLException {
//JCP>     int oid = Oid.TIMESTAMPTZ;
//JCP>     bindString(i, connection.getTimestampUtils().toString(offsetDateTime), oid);
//JCP>   }
  //JCP! endif
  ...
  //JCP! if mvn.project.property.postgresql.jdbc.spec >= "JDBC4.2"
//JCP>   public void setObject(int parameterIndex, Object x, java.sql.SQLType targetSqlType,
//JCP>       int scaleOrLength) throws SQLException {
//JCP>     throw Driver.notImplemented(this.getClass(), "setObject");
//JCP>   }
//JCP> 
//JCP>   public void setObject(int parameterIndex, Object x, java.sql.SQLType targetSqlType)
//JCP>       throws SQLException {
//JCP>     throw Driver.notImplemented(this.getClass(), "setObject");
//JCP>   }
  //JCP! endif
