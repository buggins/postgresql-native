...
module org.postgresql.util.PGtokenizer;
...
public class PGtokenizer {
   ...
   */
  public this(string str, char delim) {
    tokenize(str, delim);
  }
  ...
  public int tokenize(string str, char delim) {
    ...
    int s;
    bool skipChar = false;
    bool nestedDoubleQuote = false;

    for (p = 0, s = 0; p < str.length; p++) {
      char c = str[p];
