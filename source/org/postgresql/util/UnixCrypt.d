...
module org.postgresql.util.UnixCrypt;
...
public class UnixCrypt {
  ...
  private static immutable int ITERATIONS = 16;

  private static immutable int con_salt[] = [
  ...
  private static immutable bool shifts2[] = [
      false, false, true, true, true, true, true, true,
      false, true, true, true, true, true, true, false
  ];

  private static immutable int skb[][] = [[
  ...
  private static immutable int SPtrans[][] = [[
      /* nibble 0 */
  ...
  private static immutable byte cov_2byte[] = [
  ...
  private static final void intToFourBytes(int iValue, byte b[], int offset) {
    b[offset++] = cast(byte) ((iValue) & 0xff);
    b[offset++] = cast(byte) ((iValue >>> 8) & 0xff);
    b[offset++] = cast(byte) ((iValue >>> 16) & 0xff);
    b[offset++] = cast(byte) ((iValue >>> 24) & 0xff);
  }
  ...
  private static final int[] _body(int schedule[], int Eswap0, int Eswap1) {
    int left = 0;
    int right = 0;
    int t = 0;
  ...
  public static final byte[] crypt(byte salt[], byte original[]) {
    ...
    for (int i = 0; i < key.length && i < original.length; i++) {
      ...
      key[i] = cast(byte) (iChar << 1);
    }

    int schedule[] = des_set_key(key);
    int _out[] = _body(schedule, Eswap0, Eswap1);

    byte b[] = new byte[9];

    intToFourBytes(_out[0], b, 0);
    intToFourBytes(_out[1], b, 4);
    b[8] = 0;
