module org.postgresql.util.Base64;
...
public class Base64 {
   ...
   */
  public immutable static int NO_OPTIONS = 0;

  /**
   * Specify encoding.
   */
  public immutable static int ENCODE = 1;


  /**
   * Specify decoding.
   */
  public immutable static int DECODE = 0;


  /**
   * Don't break lines when encoding (violates strict Base64 specification)
   */
  public immutable static int DONT_BREAK_LINES = 8;
   ...
   */
  private immutable static int MAX_LINE_LENGTH = 76;


  /**
   * The equals sign (=) as a byte.
   */
  private immutable static byte EQUALS_SIGN = cast(byte) '=';


  /**
   * The new line character (\n) as a byte.
   */
  private immutable static byte NEW_LINE = cast(byte) '\n';


  /**
   * Preferred encoding.
   */
  private immutable static string PREFERRED_ENCODING = "UTF-8";


  /**
   * The 64 valid Base64 values.
   */
  private immutable static byte[] ALPHABET = _NATIVE_ALPHABET;
  private immutable static byte[] _NATIVE_ALPHABET = [ /* May be something funny like EBCDIC */
      cast(byte) 'A', cast(byte) 'B', cast(byte) 'C', cast(byte) 'D', cast(byte) 'E', cast(byte) 'F', cast(byte) 'G',
      cast(byte) 'H', cast(byte) 'I', cast(byte) 'J', cast(byte) 'K', cast(byte) 'L', cast(byte) 'M', cast(byte) 'N',
      cast(byte) 'O', cast(byte) 'P', cast(byte) 'Q', cast(byte) 'R', cast(byte) 'S', cast(byte) 'T', cast(byte) 'U',
      cast(byte) 'V', cast(byte) 'W', cast(byte) 'X', cast(byte) 'Y', cast(byte) 'Z',
      cast(byte) 'a', cast(byte) 'b', cast(byte) 'c', cast(byte) 'd', cast(byte) 'e', cast(byte) 'f', cast(byte) 'g',
      cast(byte) 'h', cast(byte) 'i', cast(byte) 'j', cast(byte) 'k', cast(byte) 'l', cast(byte) 'm', cast(byte) 'n',
      cast(byte) 'o', cast(byte) 'p', cast(byte) 'q', cast(byte) 'r', cast(byte) 's', cast(byte) 't', cast(byte) 'u',
      cast(byte) 'v', cast(byte) 'w', cast(byte) 'x', cast(byte) 'y', cast(byte) 'z',
      cast(byte) '0', cast(byte) '1', cast(byte) '2', cast(byte) '3', cast(byte) '4', cast(byte) '5',
      cast(byte) '6', cast(byte) '7', cast(byte) '8', cast(byte) '9', cast(byte) '+', cast(byte) '/'
  ];
  ...
  */
   ...
   **/
  private immutable static byte[] DECODABET = [-9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal 0 - 8
  ...
  private immutable static byte WHITE_SPACE_ENC = -5; // Indicates white space in encoding
  private immutable static byte EQUALS_SIGN_ENC = -1; // Indicates equals sign in encoding
  ...
  public static string encodeBytes(byte[] source, int off, int len, int options) {
    ...
    // Else, don't compress. Better not to use streams at all then.
    {
      ...
      return cast(string)outBuff[0..e];
  ...
  private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset) {
    ...
    if (source[srcOffset + 2] == EQUALS_SIGN) {
      ...
      destination[destOffset] = cast(byte) (outBuff >>> 16);
      return 1;
      ...
      destination[destOffset] = cast(byte) (outBuff >>> 16);
      destination[destOffset + 1] = cast(byte) (outBuff >>> 8);
      return 2;
    } else {
      // Example: DkLE
      try {
        ...
        destination[destOffset] = cast(byte) (outBuff >> 16);
        destination[destOffset + 1] = cast(byte) (outBuff >> 8);
        destination[destOffset + 2] = cast(byte) (outBuff);
  ...
  public static byte[] decode(byte[] source, int off, int len) {
    ...
    for (i = off; i < off + len; i++) {
      sbiCrop = cast(byte) (source[i] & 0x7f); // Only the low seven bits
    ...
    return outBuff[0 .. outBuffPosn].dup;
  } // end decode
